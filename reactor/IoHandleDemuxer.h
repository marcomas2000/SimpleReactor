...
#ifndef SIMPLE_REACTOR_REACTOR_IOHANDLEDEMUXER_H_
#define SIMPLE_REACTOR_REACTOR_IOHANDLEDEMUXER_H_
...
#define INIT_EPOLL_EVENT_VALUE (EPOLLHUP | EPOLLRDHUP)
                                                                  ...
                                                                  const CtrlEventData &ctrl_events)
  {
    ...
    case EVENT_REGISTER_ALL:
      ...
      break;
    case EVENT_REGISTER_READ:
      add_epoll_event(EVENT_READ, ctrl_events.io_handle);
      break;
    case EVENT_REGISTER_WRITE:
      add_epoll_event(EVENT_WRITE, ctrl_events.io_handle);
      break;
    case EVENT_REGISTER_ERROR:
      add_epoll_event(EVENT_ERROR, ctrl_events.io_handle);
      break;
    case EVENT_REMOVE_READ:
      del_epoll_event(EVENT_READ, ctrl_events.io_handle);
      break;
    case EVENT_REMOVE_WRITE:
      del_epoll_event(EVENT_WRITE, ctrl_events.io_handle);
      break;
    case EVENT_REMOVE_ERROR:
      del_epoll_event(EVENT_ERROR, ctrl_events.io_handle);
      break;
    case EVENT_REMOVE_ALL:
      del_epoll_events(ctrl_events.io_handle);
      break;
    default:
      (void)ctrl_events.type;
      break;
    }
  ...
  template <typename USER_DATA_T, USER_DATA_T default_value>
  int IoHandleDemuxer<USER_DATA_T, default_value>::wait(std::vector<EventData> &return_events,
...
#endif // SIMPLE_REACTOR_REACTOR_IOHANDLEDEMUXER_H_
